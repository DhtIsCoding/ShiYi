...
//	private static extern int ConvertWorldToDepth(float worldX, float worldY, float worldZ, out float depthX, out float depthY, out float depthZ);
	...
	public void ApplyXOffset(float fVal01)
	{
	...
	public void ApplyYOffset(float fVal01)
	{
		float fValue = (fVal01 - 0.5f) * 40000f;
...
//			this.vMatAdjustX = new Vector4(0f, 0f, 7.02248f, 0f);  //1.
//			this.vMatAdjustY = new Vector4(0f, 0f, 5.33708f, 0f);
//			this.vMatAdjustX = new Vector4(0f, 0f, -3.93258f, 0f); //2.
//			this.vMatAdjustY = new Vector4(0f, 0f, 30.33708f, 0f);
	...
	private void SetupMatricesRow()
	{
		...
		matCamD2C.SetRow(0, vD2CRow0);
		matCamD2C.SetRow(1, vD2CRow1);
